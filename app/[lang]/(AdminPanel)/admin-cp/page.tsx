...
async function fetchPost() {
  try {
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_WEB_URL}/api/get-project-new`
    );
  ...
  return (
    <main className="flex h-screen">
      <div className="my-[25px] flex w-screen lg:h-auto flex-col short:justify-start lg:justify-center items-center">
        ...
        <div className="w-[90%] short:h-auto lg:h-[45%] flex flex-col justify-center short:flex-col lg:flex-row mb-5 gap-5 short:gap-5 lg:gap-0 items-center">
          <div className="bg-secondTheme h-[250px] short:h-[250px] lg:h-[100%] w-[100%] sm:w-[75%] short:w-[75%] lg:w-[80%] rounded-3xl flex items-center justify-center order-1 short:order-1 lg:order-2">
            <div className="w-[90%] h-[90%]">
              <ChartVisitor locale={dashboard} lang={lang} />
            </div>
          </div>
        </div>
        <div className="w-[90%] h-[auto] short:h-[auto] lg:h-[45%] flex flex-col justify-center items-center short:flex-col lg:flex-row">
          <div className="w-[100%] short:w-[100%] lg:w-[80%] short:h-[auto] lg:h-[100%] rounded-3xl flex flex-col short:flex-col lg:flex-row items-center short:items-center lg:items-start gap-5 short:gap-5 lg:gap-0 mt-5 short:mt-5 lg:mt-0">
