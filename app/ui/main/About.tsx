    ...
    <>
      <div className="h-[400px] w-full bg-[#0d0d0d] flex">
        <div className="mx-5 lg:mx-32">
          <div className="text-thirdTheme my-8 text-sm md:text-md">
            {dict.about.title}
          </div>
          <div className="text-thirdTheme text-2xl sm:text-3xl md:text-6xl font-bold">
            {dict.about.content1}
          ...
          <div className="mt-[30px] border-b-[1px] border-[#b7ab9844]">
            <div className="group boxEffect select-none border-t-[1px] border-[#b7ab9844]">
              <div className="relative group-hover:text-black">
                <div className="e flex justify-end items-center h-[80px] lg:h-[100px] text-black bg-mainTheme ">
                  <span className="leading-5 sm:leading-6 lg:leading-7 text-md w-[90%] lg:w-[30%] mr-3 md:mr-10">
                    {dict.whatIDo.content.responsive.content}
                  </span>
                </div>
                <p className="group-hover:hidden lg:group-hover:flex absolute top-0 mx-5 md:mx-32 mt-0 h-[100%] flex items-center text-4xl lg:text-[80px] font-bold">
